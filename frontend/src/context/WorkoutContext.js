...
export const WorkoutContextProvider = ({ children }) => {//here the children property represent the app component that we wrapped with context provider in index file
